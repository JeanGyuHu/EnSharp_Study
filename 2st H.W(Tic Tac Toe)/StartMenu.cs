...
namespace Enjoy_Day2
{
    class StartMenu
    {
        ...
        private List<UserData> listWinnerName = new List<UserData>();
        private ArrayList arrComputerWin = new ArrayList();
        public StartMenu()
        {
            ...
            while (true)
            {
                ...
                switch (intGameMode)
                {
                    case 1:
                        Console.Clear();
                        makeUserID = new MakeUserID(intGameMode, listWinnerName, arrComputerWin);
                        break;
                    ...
                    case 3:
                        Console.Clear();
                        scoreBoard = new ScoreBoard(listWinnerName, arrComputerWin);
                        break;
                    case 4:
                        Environment.Exit(0);
                        break;
